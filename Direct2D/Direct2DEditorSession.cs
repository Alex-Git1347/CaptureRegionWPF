...
namespace CaptureRegionWPF.Direct2D
{
    public class Direct2DEditorSession : IDisposable
    {
        ...
        Factory1 _factory;
        SharpDX.DirectWrite.Factory _writeFactory;
        ImagingFactory _imagingFactory;

        //public SharpDX.DirectWrite.Factory WriteFactory => _writeFactory ??= new SharpDX.DirectWrite.Factory();
