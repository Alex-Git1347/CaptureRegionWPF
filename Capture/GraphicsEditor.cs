...
namespace CaptureRegionWPF.Capture
{
    public class GraphicsEditor : IEditableFrame
    {
        ...
        public void DrawLine(Point Start, Point End, System.Drawing.Color Color, float Width)
        {
            throw new NotImplementedException();
        }

        public void DrawArrow(Point Start, Point End, System.Drawing.Color Color, float Width)
        {
            throw new NotImplementedException();
        }

        public void FillRectangle(System.Drawing.Color Color, RectangleF Rectangle)
        {
            throw new NotImplementedException();
        }

        public void FillRectangle(System.Drawing.Color Color, RectangleF Rectangle, int CornerRadius)
        {
            throw new NotImplementedException();
        }

        public void DrawRectangle(System.Drawing.Color Color, float StrokeWidth, RectangleF Rectangle)
        {
            throw new NotImplementedException();
        }

        public void DrawRectangle(System.Drawing.Color Color, float StrokeWidth, RectangleF Rectangle, int CornerRadius)
        {
            throw new NotImplementedException();
        }

        public void FillEllipse(System.Drawing.Color Color, RectangleF Rectangle)
        {
            throw new NotImplementedException();
        }

        public void DrawEllipse(System.Drawing.Color Color, float StrokeWidth, RectangleF Rectangle)
        {
            throw new NotImplementedException();
        }

        public void DrawString(string Text, IFont Font, System.Drawing.Color Color, RectangleF LayoutRectangle)
        {
            throw new NotImplementedException();
        }
