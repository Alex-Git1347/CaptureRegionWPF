...
using CaptureRegionWPF.Models;
using System.Drawing;

namespace CaptureRegionWPF.ViewModels
{
    public class RegionSelectorViewModel : BindableBase
    {
        int _left = 50,
            _top = 50,
            _width = 500,
        ...
        public int Width
        {
            ...
            set
            {
                SetProperty(ref _width, Math.Max(value, MinWidth));
        ...
        public int Height
        {
            ...
            set
            {
                SetProperty(ref _height, Math.Max(value, MinHeight));
